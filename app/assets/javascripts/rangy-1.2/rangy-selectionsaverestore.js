...
rangy.createModule("SaveRestore", function (h, m) {
    ...
    h.saveSelection = function (a) {
        ...
        if (h.isSelectionValid(a)) {
            ...
            for (b = i - 1; b >= 0; --b) {
                d = c[b];
                if (d.collapsed)d.collapseBefore((g || document).getElementById(f[b].markerId)); else {
    ...
    h.restoreSelection = function (a, g) {
        if (!a.restored) {
            for (var e = a.rangeInfos, c = h.getSelection(a.win), f = [], d = e.length, j = d - 1, b, i; j >= 0; --j) {
                ...
                if (b.collapsed)if (b = (a.doc || document).getElementById(b.markerId)) {
                ...
                } else m.warn("Marker element has been removed. Cannot restore selection."); else {
    ...
    h.removeMarkers = function (a) {
        for (var g = a.rangeInfos, e = 0, c = g.length, f; e < c; ++e) {
            f = g[e];
            if (f.collapsed)k(a.doc, f.markerId); else {
