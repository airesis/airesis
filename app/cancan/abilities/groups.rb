module Abilities
  class Groups
    ...
    def group_permissions(user)
      group_management_permissions(user)

      group_documents_permissions(user)

      group_posts_permissions(user)

      group_proposals_permissions(user)
      group_events_permissions(user)
    end

    def group_management_permissions(user)
      ...
      group_destroy_permissions(user)
    end

    def group_create_permissions(user)
      can :new, Group
    ...
    def group_destroy_permissions(user)
