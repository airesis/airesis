class ReviewGroupIds < ActiveRecord::Migration
  def up
    execute " alter table supporters drop constraint supporters_group_id_fk;
              ...
              alter table partecipation_roles drop constraint partecipation_roles_group_id_fk;
              ...
              alter table group_partecipations drop constraint group_partecipations_group_id_fk;
              alter table group_partecipation_requests drop constraint group_partecipation_requests_group_id_fk;
              ...
              alter table partecipation_roles add constraint partecipation_roles_group_id_fk FOREIGN KEY (group_id) REFERENCES groups(id) ON UPDATE CASCADE ON DELETE NO ACTION;
              ...
              alter table group_partecipations add constraint group_partecipations_group_id_fk FOREIGN KEY (group_id) REFERENCES groups(id) ON UPDATE CASCADE ON DELETE NO ACTION;
              alter table group_partecipation_requests add constraint group_partecipation_requests_group_id_fk FOREIGN KEY (group_id) REFERENCES groups(id) ON UPDATE CASCADE ON DELETE NO ACTION;
