...
class TranslateSomethingElse < ActiveRecord::Migration
  def up
    ...
    GroupAction.find_by_name("PROPOSAL_PARTECIPATION").update_attributes({description: "Contribute to proposals"})
    ...
    GroupAction.find_by_name("REQUEST_ACCEPT").update_attributes({description: "Adicionar participantes ao grupo"})
    ...
    GroupAction.find_by_name("PROPOSAL_PARTECIPATION").update_attributes({description: "Contribuir as propostas"})
    ...
    GroupAction.find_by_name("PROPOSAL_PARTECIPATION").update_attributes({description: "Zu den Vorschlägen beitragen"})
    ...
    GroupAction.find_by_name("REQUEST_ACCEPT").update_attributes({description: "Adición de participantes en el grupo"})
    ...
    GroupAction.find_by_name("PROPOSAL_PARTECIPATION").update_attributes({description: "Contribuir a las propuestas"})
    ...
    GroupAction.find_by_name("PROPOSAL_PARTECIPATION").update_attributes({description: "Contribuer aux propositions"})
