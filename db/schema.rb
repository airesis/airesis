...
ActiveRecord::Schema.define(:version => 20120401205249) do
  ...
  add_foreign_key "meetings_organizations", "events", :name => "Ref_meetings_organizations_to_events"
  add_foreign_key "meetings_organizations", "groups", :name => "Ref_meetings_organizations_to_groups"
