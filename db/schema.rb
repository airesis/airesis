...
ActiveRecord::Schema.define(version: 20150519151733) do
  ...
  add_index "blog_tags", ["blog_id", "tag_id"], name: "index_blog_tags_on_blog_id_and_tag_id", unique: true, using: :btree
