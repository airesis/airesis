...
NotificationType.create(name: 'new_contributes_mine', notification_category_id: nc6.id, email_delay: 2, alert_delay: 1) { |c| c.id = 5 }.save
...
NotificationType.create(name: 'available_author', notification_category_id: nc6.id, email_delay: 2, alert_delay: 1) { |c| c.id = 22 }.save
...
NotificationType.create(name: 'new_comments', notification_category_id: nc7.id, email_delay: 2, alert_delay: 1) { |c| c.id = 28 }.save
...
NotificationType.create(name: "new_participation_request", notification_category_id: nc10.id, email_delay: 2, alert_delay: 1) { |c| c.id = 12 }.save
...
NotificationType.create(name: "new_blog_comment", notification_category_id: nc10.id, email_delay: 2, alert_delay: 1) { |c| c.id = 26 }.save
