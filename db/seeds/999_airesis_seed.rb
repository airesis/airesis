...
NotificationType.create(name: 'new_valutation_mine', notification_category_id: nc6.id, email_delay: 2, alert_delay: 1) { |c| c.id = 20 }.save
...
SysLocale.create(key: 'fr', host: 'www.airesis.eu', territory_type: 'Country', territory_id: '18', lang: 'fr')
SysLocale.create(key: 'es-ES', host: 'www.airesis.eu', territory_type: 'Country', territory_id: '47', lang: 'es-ES')
SysLocale.create(key: 'pt-PT', host: 'www.airesis.eu', territory_type: 'Country', territory_id: '41', lang: 'pt-PT')
SysLocale.create(key: 'de', host: 'www.airesis.eu', territory_type: 'Country', territory_id: '19', lang: 'de')
SysLocale.create(key: 'pt-BR', host: 'www.airesis.us', territory_type: 'Country', territory_id: '54', lang: 'pt-BR')
SysLocale.create(key: 'es-EC', host: 'www.airesis.us', territory_type: 'Country', territory_id: '53', lang: 'es-EC')
SysLocale.create(key: 'zh', host: 'www.airesis.cn', territory_type: 'Country', territory_id: '91')
SysLocale.create(key: 'ro-RO', host: 'www.airesis.eu', territory_type: 'Country', territory_id: '42', lang: 'ro-RO')
SysLocale.create(key: 'es-CL', host: 'www.airesis.us', territory_type: 'Country', territory_id: '90', lang: 'es-CL')
SysLocale.create(key: 'crowdin', host: 'www.airesis.eu', territory_type: '', territory_id: '', lang: 'crowdin')
SysLocale.create(key: 'it-IT', host: 'www.airesisdev.it', territory_type: 'Country', territory_id: '1')
SysLocale.create(key: 'en', host: 'www.airesis.eu', territory_type: 'Continent', territory_id: '1', default: true)
SysLocale.create(key: 'en-US', host: 'www.airesis.us', territory_type: 'Continent', territory_id: '2')
SysLocale.create(key: 'hu', host: 'www.airesis.eu', territory_type: 'Country', territory_id: '210', lang: 'hu')
SysLocale.create(key: 'el', host: 'www.airesis.eu', lang: 'el', territory: Country.find_by(description: 'Greece'))
SysLocale.create(key: 'en-GB', host: 'www.airesis.eu', lang: 'en-GB', territory: Country.find_by(description: 'United Kingdom'))
SysLocale.create(key: 'en-ZA', host: 'www.airesis.eu', lang: 'en-ZA', territory: Country.find_by(description: 'South Africa'))
SysLocale.create(key: 'en-NZ', host: 'www.airesis.eu', lang: 'en-NZ', territory: Country.find_by(description: 'New Zealand'))
SysLocale.create(key: 'en-AU', host: 'www.airesis.eu', lang: 'en-AU', territory: Country.find_by(description: 'Australia'))
