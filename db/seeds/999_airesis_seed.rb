...
SysLocale.create(key: 'crowdin', host: 'localhost', territory: Continent.find_by(description: 'Europe'), lang: 'crowdin')
...
SysLocale.create(key: 'sh-HR', host: 'localhost', territory: Country.find_by(description: 'Serbia'), lang: 'sh-HR')
