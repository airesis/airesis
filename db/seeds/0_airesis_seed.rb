a2 = Continent.create(description: "America")
 ...
 s53 = Country.create( description: "Ecuador", continent_id: a2.id, sigla: "EC", sigla_ext: "")
  ...
  r21 = Regione.create(description: "Norte", country_id: s53.id, continent_id: a2.id)
  r22 = Regione.create(description: "Centro-Norte", country_id: s53.id, continent_id: a2.id)
  r23 = Regione.create(description: "Centro", country_id: s53.id, continent_id: a2.id)
  r24 = Regione.create(description: "Pacifico", country_id: s53.id, continent_id: a2.id)
  r25 = Regione.create(description: "Litoral", country_id: s53.id, continent_id: a2.id)
  r26 = Regione.create(description: "Centro-Sur", country_id: s53.id, continent_id: a2.id)
  r27 = Regione.create(description: "Sur", country_id: s53.id, continent_id: a2.id)
  r28 = Regione.create(description: "Galápagos", country_id: s53.id, continent_id: a2.id)
 ...
 s90 = Country.create( description: "Chile", continent_id: a2.id, sigla: "CL", sigla_ext: "CHL")
  ...
  r38 = Regione.create(description: "Arica and Parinacota", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Arica", regione_id: r38.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Parinacota", regione_id: r38.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r39 = Regione.create(description: "Tarapacá", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Iquique", regione_id: r39.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Tamarugal", regione_id: r39.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r40 = Regione.create(description: "Antofagasta", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Antofagasta", regione_id: r40.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "El Loa", regione_id: r40.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Tocopilla", regione_id: r40.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r41 = Regione.create(description: "Atacama", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Chañaral", regione_id: r41.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Copiapó", regione_id: r41.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Huasco", regione_id: r41.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r42 = Regione.create(description: "Coquimbo", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Choapa", regione_id: r42.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Elqui", regione_id: r42.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Limarí", regione_id: r42.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r43 = Regione.create(description: "Valparaíso", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Isla de Pascua", regione_id: r43.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Los Andes", regione_id: r43.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Marga Marga", regione_id: r43.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Petorca", regione_id: r43.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Quillota", regione_id: r43.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "San Antonio", regione_id: r43.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "San Felipe", regione_id: r43.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Valparaíso", regione_id: r43.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r44 = Regione.create(description: "Metropolitana", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Chacabuco", regione_id: r44.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Cordillera", regione_id: r44.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Maipo", regione_id: r44.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Melipilla", regione_id: r44.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Santiago", regione_id: r44.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Talagante", regione_id: r44.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r45 = Regione.create(description: "O 'Higgins", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Cachapoal", regione_id: r45.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Cardenal Caro", regione_id: r45.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Colchagua", regione_id: r45.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r46 = Regione.create(description: "Maule", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Cauquenes", regione_id: r46.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Curicó", regione_id: r46.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Linares", regione_id: r46.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Talca", regione_id: r46.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r47 = Regione.create(description: "Biobío", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Arauco", regione_id: r47.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Biobío", regione_id: r47.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Concepción", regione_id: r47.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Ñuble", regione_id: r47.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r48 = Regione.create(description: "Araucanía", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Cautín", regione_id: r48.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Malleco", regione_id: r48.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r49 = Regione.create(description: "Los Ríos", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Ranco", regione_id: r49.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Valdivia", regione_id: r49.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r50 = Regione.create(description: "Los Lagos", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Chiloé", regione_id: r50.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Llanquihue", regione_id: r50.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Osorno", regione_id: r50.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Palena", regione_id: r50.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r51 = Regione.create(description: "Aisén", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Aisén", regione_id: r51.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Capitán Prat", regione_id: r51.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Coihaique", regione_id: r51.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "General Carrera", regione_id: r51.id, country_id: s90.id, continent_id: a2.id, sigla: "")
  r52 = Regione.create(description: "Magallanes and Antártica Chilena", country_id: s90.id, continent_id: a2.id)
   Provincia.create(description: "Antártica Chilena", regione_id: r52.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Magallanes", regione_id: r52.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Tierra del Fuego", regione_id: r52.id, country_id: s90.id, continent_id: a2.id, sigla: "")
   Provincia.create(description: "Última Esperanza", regione_id: r52.id, country_id: s90.id, continent_id: a2.id, sigla: "")
...
a1 = Continent.create(description: "Europe")
 ...
 s1 = Country.create( description: "Italy", continent_id: a1.id, sigla: "IT", sigla_ext: "ITA")
  ...
  r20 = Regione.create(description: "Umbria", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Perugia", regione_id: r20.id, country_id: s1.id, continent_id: a1.id, sigla: "PG")
   Provincia.create(description: "Terni", regione_id: r20.id, country_id: s1.id, continent_id: a1.id, sigla: "TR")
  r19 = Regione.create(description: "Lombardia", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Bergamo", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "BG")
   Provincia.create(description: "Brescia", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "BS")
   Provincia.create(description: "Como", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "CO")
   Provincia.create(description: "Cremona", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "CR")
   Provincia.create(description: "Lecco", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "LC")
   Provincia.create(description: "Lodi", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "LO")
   Provincia.create(description: "Mantova", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "MN")
   Provincia.create(description: "Milano", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "MI")
   Provincia.create(description: "Pavia", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "PV")
   Provincia.create(description: "Sondrio", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "SO")
   Provincia.create(description: "Varese", regione_id: r19.id, country_id: s1.id, continent_id: a1.id, sigla: "VA")
  r18 = Regione.create(description: "Liguria", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Genova", regione_id: r18.id, country_id: s1.id, continent_id: a1.id, sigla: "GE")
   Provincia.create(description: "Imperia", regione_id: r18.id, country_id: s1.id, continent_id: a1.id, sigla: "IM")
   Provincia.create(description: "Savona", regione_id: r18.id, country_id: s1.id, continent_id: a1.id, sigla: "SV")
   Provincia.create(description: "La Spezia", regione_id: r18.id, country_id: s1.id, continent_id: a1.id, sigla: "SP")
  r17 = Regione.create(description: "Veneto", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Belluno", regione_id: r17.id, country_id: s1.id, continent_id: a1.id, sigla: "BL")
   Provincia.create(description: "Padova", regione_id: r17.id, country_id: s1.id, continent_id: a1.id, sigla: "PD")
   Provincia.create(description: "Rovigo", regione_id: r17.id, country_id: s1.id, continent_id: a1.id, sigla: "RO")
   Provincia.create(description: "Treviso", regione_id: r17.id, country_id: s1.id, continent_id: a1.id, sigla: "TV")
   Provincia.create(description: "Venezia", regione_id: r17.id, country_id: s1.id, continent_id: a1.id, sigla: "VE")
   Provincia.create(description: "Verona", regione_id: r17.id, country_id: s1.id, continent_id: a1.id, sigla: "VR")
   Provincia.create(description: "Vicenza", regione_id: r17.id, country_id: s1.id, continent_id: a1.id, sigla: "VI")
  r16 = Regione.create(description: "Valle d'Aosta", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Aosta", regione_id: r16.id, country_id: s1.id, continent_id: a1.id, sigla: "AO")
  r15 = Regione.create(description: "Friuli Venezia Giulia", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Gorizia", regione_id: r15.id, country_id: s1.id, continent_id: a1.id, sigla: "GO")
   Provincia.create(description: "Pordenone", regione_id: r15.id, country_id: s1.id, continent_id: a1.id, sigla: "PN")
   Provincia.create(description: "Udine", regione_id: r15.id, country_id: s1.id, continent_id: a1.id, sigla: "UD")
   Provincia.create(description: "Trieste", regione_id: r15.id, country_id: s1.id, continent_id: a1.id, sigla: "TS")
  r14 = Regione.create(description: "Emilia Romagna", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Bologna", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "BO")
   Provincia.create(description: "Ferrara", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "FE")
   Provincia.create(description: "Forlì Cesena", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "FC")
   Provincia.create(description: "Modena", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "MO")
   Provincia.create(description: "Parma", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "PR")
   Provincia.create(description: "Piacenza", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "PC")
   Provincia.create(description: "Ravenna", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "RA")
   Provincia.create(description: "Reggio Emilia", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "RE")
   Provincia.create(description: "Rimini", regione_id: r14.id, country_id: s1.id, continent_id: a1.id, sigla: "RN")
  r13 = Regione.create(description: "Piemonte", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Alessandria", regione_id: r13.id, country_id: s1.id, continent_id: a1.id, sigla: "AL")
   Provincia.create(description: "Asti", regione_id: r13.id, country_id: s1.id, continent_id: a1.id, sigla: "AT")
   Provincia.create(description: "Biella", regione_id: r13.id, country_id: s1.id, continent_id: a1.id, sigla: "BI")
   Provincia.create(description: "Cuneo", regione_id: r13.id, country_id: s1.id, continent_id: a1.id, sigla: "CN")
   Provincia.create(description: "Novara", regione_id: r13.id, country_id: s1.id, continent_id: a1.id, sigla: "NO")
   Provincia.create(description: "Vercelli", regione_id: r13.id, country_id: s1.id, continent_id: a1.id, sigla: "VC")
   Provincia.create(description: "Torino", regione_id: r13.id, country_id: s1.id, continent_id: a1.id, sigla: "TO")
   Provincia.create(description: "Verbania", regione_id: r13.id, country_id: s1.id, continent_id: a1.id, sigla: "VB")
  r12 = Regione.create(description: "Toscana", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Arezzo", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "AR")
   Provincia.create(description: "Firenze", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "FI")
   Provincia.create(description: "Grosseto", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "GR")
   Provincia.create(description: "Livorno", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "LI")
   Provincia.create(description: "Lucca", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "LU")
   Provincia.create(description: "Massa Carrara", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "MS")
   Provincia.create(description: "Pisa", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "PI")
   Provincia.create(description: "Pistoia", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "PT")
   Provincia.create(description: "Siena", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "SI")
   Provincia.create(description: "Prato", regione_id: r12.id, country_id: s1.id, continent_id: a1.id, sigla: "PO")
  r11 = Regione.create(description: "Sicilia", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Agrigento", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "AG")
   Provincia.create(description: "Caltanissetta", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "CL")
   Provincia.create(description: "Catania", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "CT")
   Provincia.create(description: "Enna", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "EN")
   Provincia.create(description: "Messina", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "ME")
   Provincia.create(description: "Palermo", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "PA")
   Provincia.create(description: "Ragusa", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "RG")
   Provincia.create(description: "Siracusa", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "SR")
   Provincia.create(description: "Trapani", regione_id: r11.id, country_id: s1.id, continent_id: a1.id, sigla: "TP")
  r10 = Regione.create(description: "Sardegna", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Cagliari", regione_id: r10.id, country_id: s1.id, continent_id: a1.id, sigla: "CA")
   Provincia.create(description: "Nuoro", regione_id: r10.id, country_id: s1.id, continent_id: a1.id, sigla: "NU")
   Provincia.create(description: "Oristano", regione_id: r10.id, country_id: s1.id, continent_id: a1.id, sigla: "OR")
   Provincia.create(description: "Sassari", regione_id: r10.id, country_id: s1.id, continent_id: a1.id, sigla: "SS")
   Provincia.create(description: "Carbonia Iglesias", regione_id: r10.id, country_id: s1.id, continent_id: a1.id, sigla: "CI")
   Provincia.create(description: "Medio Campidano", regione_id: r10.id, country_id: s1.id, continent_id: a1.id, sigla: "VS")
   Provincia.create(description: "Ogliastra", regione_id: r10.id, country_id: s1.id, continent_id: a1.id, sigla: "OG")
   Provincia.create(description: "Olbia Tempio", regione_id: r10.id, country_id: s1.id, continent_id: a1.id, sigla: "OT")
  r9 = Regione.create(description: "Lazio", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Frosinone", regione_id: r9.id, country_id: s1.id, continent_id: a1.id, sigla: "FR")
   Provincia.create(description: "Latina", regione_id: r9.id, country_id: s1.id, continent_id: a1.id, sigla: "LT")
   Provincia.create(description: "Rieti", regione_id: r9.id, country_id: s1.id, continent_id: a1.id, sigla: "RI")
   Provincia.create(description: "Roma", regione_id: r9.id, country_id: s1.id, continent_id: a1.id, sigla: "RM")
   Provincia.create(description: "Viterbo", regione_id: r9.id, country_id: s1.id, continent_id: a1.id, sigla: "VT")
  r8 = Regione.create(description: "Campania", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Avellino", regione_id: r8.id, country_id: s1.id, continent_id: a1.id, sigla: "AV")
   Provincia.create(description: "Benevento", regione_id: r8.id, country_id: s1.id, continent_id: a1.id, sigla: "BN")
   Provincia.create(description: "Caserta", regione_id: r8.id, country_id: s1.id, continent_id: a1.id, sigla: "CE")
   Provincia.create(description: "Napoli", regione_id: r8.id, country_id: s1.id, continent_id: a1.id, sigla: "NA")
   Provincia.create(description: "Salerno", regione_id: r8.id, country_id: s1.id, continent_id: a1.id, sigla: "SA")
  r7 = Regione.create(description: "Calabria", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Catanzaro", regione_id: r7.id, country_id: s1.id, continent_id: a1.id, sigla: "CZ")
   Provincia.create(description: "Cosenza", regione_id: r7.id, country_id: s1.id, continent_id: a1.id, sigla: "CS")
   Provincia.create(description: "Crotone", regione_id: r7.id, country_id: s1.id, continent_id: a1.id, sigla: "KR")
   Provincia.create(description: "Reggio Calabria", regione_id: r7.id, country_id: s1.id, continent_id: a1.id, sigla: "RC")
   Provincia.create(description: "Vibo Valentia", regione_id: r7.id, country_id: s1.id, continent_id: a1.id, sigla: "VV")
  r6 = Regione.create(description: "Puglia", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Bari", regione_id: r6.id, country_id: s1.id, continent_id: a1.id, sigla: "BA")
   Provincia.create(description: "Brindisi", regione_id: r6.id, country_id: s1.id, continent_id: a1.id, sigla: "BR")
   Provincia.create(description: "Foggia", regione_id: r6.id, country_id: s1.id, continent_id: a1.id, sigla: "FG")
   Provincia.create(description: "Lecce", regione_id: r6.id, country_id: s1.id, continent_id: a1.id, sigla: "LE")
   Provincia.create(description: "Taranto", regione_id: r6.id, country_id: s1.id, continent_id: a1.id, sigla: "TA")
  r5 = Regione.create(description: "Trentino Alto Adige", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Trento", regione_id: r5.id, country_id: s1.id, continent_id: a1.id, sigla: "TN")
   Provincia.create(description: "Bolzano", regione_id: r5.id, country_id: s1.id, continent_id: a1.id, sigla: "BZ")
  r4 = Regione.create(description: "Molise", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Isernia", regione_id: r4.id, country_id: s1.id, continent_id: a1.id, sigla: "IS")
   Provincia.create(description: "Campobasso", regione_id: r4.id, country_id: s1.id, continent_id: a1.id, sigla: "CB")
  r3 = Regione.create(description: "Basilicata", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Matera", regione_id: r3.id, country_id: s1.id, continent_id: a1.id, sigla: "MT")
   Provincia.create(description: "Potenza", regione_id: r3.id, country_id: s1.id, continent_id: a1.id, sigla: "PZ")
  r2 = Regione.create(description: "Abruzzo", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Chieti", regione_id: r2.id, country_id: s1.id, continent_id: a1.id, sigla: "CH")
   Provincia.create(description: "L'Aquila", regione_id: r2.id, country_id: s1.id, continent_id: a1.id, sigla: "AQ")
   Provincia.create(description: "Pescara", regione_id: r2.id, country_id: s1.id, continent_id: a1.id, sigla: "PE")
   Provincia.create(description: "Teramo", regione_id: r2.id, country_id: s1.id, continent_id: a1.id, sigla: "TE")
  r1 = Regione.create(description: "Marche", country_id: s1.id, continent_id: a1.id)
   Provincia.create(description: "Ancona", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "AN")
   Provincia.create(description: "Macerata", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "MC")
   Provincia.create(description: "Pesaro Urbino", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "PU")
   Provincia.create(description: "Ascoli Piceno", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "AP")
   Provincia.create(description: "Carchi", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "CAR")
   Provincia.create(description: "Esmeraldas", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "ESM")
   Provincia.create(description: "Imbabura", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "IMB")
   Provincia.create(description: "Sucumbíos", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "SUC")
   Provincia.create(description: "Napo", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "NAP")
   Provincia.create(description: "Orellana", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "ORE")
   Provincia.create(description: "Pichincha", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "PIC")
   Provincia.create(description: "Chimborazo", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "CHI")
   Provincia.create(description: "Cotopaxi", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "COT")
   Provincia.create(description: "Pastaza", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "PAS")
   Provincia.create(description: "Tungurahua", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "TUN")
   Provincia.create(description: "Azuay", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "AZU")
   Provincia.create(description: "Cañar", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "CAN")
   Provincia.create(description: "Morona Santiago", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "MSA")
   Provincia.create(description: "El Oro", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "EOR")
   Provincia.create(description: "Loja", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "LOJ")
   Provincia.create(description: "Zamora Chinchipe", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "ZCH")
   Provincia.create(description: "Bolívar", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "BOL")
   Provincia.create(description: "Guayas", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "GUA")
   Provincia.create(description: "Los Ríos", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "LRI")
   Provincia.create(description: "Santa Elena", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "SEL")
   Provincia.create(description: "Manabí", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "MAN")
   Provincia.create(description: "Santo Domingo de los Tsáchilas", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "SDT")
   Provincia.create(description: "Galápagos", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "GAL")
   Provincia.create(description: "Alba", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Arad", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Argeș", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Bacău", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Bihor", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Bistrița-Năsăud", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Botoșani", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Brașov", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Brăila", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Buzău", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Caraș-Severin", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Călărași", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Cluj", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Constanța", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Covasna", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Dâmbovița", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Dolj", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Galați", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Giurgiu", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Gorj", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Harghita", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Hunedoara", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Ialomița", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Iași", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Ilfov", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Maramureș", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Mehedinți", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Mureș", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Neamț", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Olt", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Prahova", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Satu Mare", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Sălaj", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Sibiu", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Suceava", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Teleorman", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Timiș", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Tulcea", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Vaslui", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Vâlcea", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Vrancea", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
   Provincia.create(description: "Mun. Bucuresti", regione_id: r1.id, country_id: s1.id, continent_id: a1.id, sigla: "")
 ...
 s42 = Country.create( description: "Romania", continent_id: a1.id, sigla: "RO", sigla_ext: "ROU")
  ...
  r29 = Regione.create(description: "Bucovina", country_id: s42.id, continent_id: a1.id)
  r30 = Regione.create(description: "Crișana", country_id: s42.id, continent_id: a1.id)
  r31 = Regione.create(description: "Dobrogea", country_id: s42.id, continent_id: a1.id)
  r32 = Regione.create(description: "Oltenia", country_id: s42.id, continent_id: a1.id)
  r33 = Regione.create(description: "Maramureș", country_id: s42.id, continent_id: a1.id)
  r34 = Regione.create(description: "Moldova", country_id: s42.id, continent_id: a1.id)
  r35 = Regione.create(description: "Muntenia", country_id: s42.id, continent_id: a1.id)
  r36 = Regione.create(description: "Transilvania", country_id: s42.id, continent_id: a1.id)
  r37 = Regione.create(description: "Banat", country_id: s42.id, continent_id: a1.id)
