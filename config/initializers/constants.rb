...
DEFAULT_CHANGE_ADVANCED_OPTIONS = (ENV['DEFAULT_CHANGE_ADVANCED_OPTIONS'].downcase == "true")
DEFAULT_ANONIMA = (ENV['DEFAULT_ANONIMA'].downcase == "true")
...
LIMIT_COMMENTS = (ENV['LIMIT_COMMENTS'].downcase == "true")
COMMENTS_TIME_LIMIT = (ENV['COMMENTS_TIME_LIMIT'].to_i || 30).seconds
LIMIT_PROPOSALS = (ENV['LIMIT_PROPOSALS'].downcase == "true")
PROPOSALS_TIME_LIMIT = (ENV['PROPOSALS_TIME_LIMIT'].to_i || 60).seconds
LIMIT_GROUPS = (ENV['LIMIT_GROUPS'].downcase == "true")
